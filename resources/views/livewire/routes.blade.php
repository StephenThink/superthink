                            ...
                            @if ($data->count())
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-2">{{ $item->view }}</td>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <select wire:model="type" id="" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            ...
            <div class="mt-4">
                ...
                <x-jet-input wire:model.debounce.300ms="address" id="" class="block mt-1 w-full" type="text" />
                @error('address') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                <x-jet-label for="view" value="{{ __('View') }}" />
                <x-jet-input wire:model="view" id="" class="block mt-1 w-full" type="text" />
                @error('view') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
