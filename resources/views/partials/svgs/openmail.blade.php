<svg xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out hover:scale-150 h-6 w-6 hover:text-yellow" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
