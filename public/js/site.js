...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_hamburger_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/hamburger.js */ "./resources/js/components/hamburger.js");
/* harmony import */ var _components_BlogArrowAnimation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/BlogArrowAnimation.js */ "./resources/js/components/BlogArrowAnimation.js");



/***/ }),

/***/ "./resources/js/components/BlogArrowAnimation.js":
/*!*******************************************************!*\
  !*** ./resources/js/components/BlogArrowAnimation.js ***!
  \*******************************************************/
/*! no exports provided */
...
//     let arrowLeft = document.querySelectorAll('.blog-arrow-left')[0];
//     let arrowRight = document.querySelectorAll('.blog-arrow-right')[0];
//     let tl = gsap.timeline({repeat:-1})
//     arrowRight.addEventListener('mouseover', function(e) {
//         let el = this.querySelectorAll('#Line_2');
//         tl.to(el, {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var state = handle.dataset.state;
  var open = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline();
  var close = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline();
  burger.addEventListener('click', function (e) {
    e.preventDefault(); // if(state == 'closed') {
    //     console.log('open the nav');
    // handle.dataset.state = 'open';

    nav.classList.toggle('open');
    handle.classList.toggle('open'); //     open.to(handle, {
...
var wipe = function wipe(way, obj) {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_6__["default"].to(wipe, {
    duration: "1.5",
    x: "0",
    ease: "power4.out",
    delay: delay
  });
  gsap__WEBPACK_IMPORTED_MODULE_6__["default"].to(image, {
    x: "0",
    duration: "2",
    opacity: 1,
    ease: "power4.out",
...
var moveSlide = function moveSlide(e) {
  ...
  sectionOutMove = findTheActiveOne('.filter-section', true); //bail if we have press the same button. 
...
doc.addEventListener('DOMContentLoaded', function () {
  ...
  }, _helpers_ScrollerSettings__WEBPACK_IMPORTED_MODULE_2__["scroll"].options)); // inView('.fancy:not(.seen)').on('enter', animateIn);
  ...
  _barba_core__WEBPACK_IMPORTED_MODULE_5___default.a.hooks.enter(function () {
    window.scrollTo(0, 0);
  }); //  Always close the navigation when leaving a page. 

  _barba_core__WEBPACK_IMPORTED_MODULE_5___default.a.hooks.beforeLeave(function () {
    var handle = document.getElementById('handle');
    var nav = document.getElementById('navigation-panel');
