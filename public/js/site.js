...
/***/ "./resources/js/pageTransitions.js":
/*!*****************************************!*\
  !*** ./resources/js/pageTransitions.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _transitions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./transitions */ "./resources/js/transitions/index.js");
/* harmony import */ var _default_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./default.js */ "./resources/js/default.js");
...
_barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.afterEnter(function () {
  (0,_default_js__WEBPACK_IMPORTED_MODULE_2__.page)();
});
_barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
  ...
  'transitions': [{
    name: 'default',
    once: function once() {
      return (0,_transitions__WEBPACK_IMPORTED_MODULE_1__.mainNavigationOnce)();
    },
    leave: function leave() {// console.log('default') 
    },
    ...
    leave: function leave(_ref3) {
      ...
      return (0,_transitions__WEBPACK_IMPORTED_MODULE_1__.mainNavigationLeave)(current.container);
    },
    enter: function enter(_ref4) {
      var current = _ref4.current,
          next = _ref4.next;
      return (0,_transitions__WEBPACK_IMPORTED_MODULE_1__.mainNavigationEnter)(current, next);
    }
  }, {
    name: 'blog-item',
    from: {
    ...
    leave: function leave(_ref6) {
      ...
      return (0,_transitions__WEBPACK_IMPORTED_MODULE_1__.blogItemLeave)(current.container, trigger);
    },
    enter: function enter(_ref7) {
      var next = _ref7.next;
      return (0,_transitions__WEBPACK_IMPORTED_MODULE_1__.blogItemEnter)(next.container);
    }
  }]
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _pageTransitions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pageTransitions.js */ "./resources/js/pageTransitions.js");
/* harmony import */ var _default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./default */ "./resources/js/default.js");
...
(0,_default__WEBPACK_IMPORTED_MODULE_1__.page)(); // components
...
/***/ "./resources/js/transitions/blogItemEnter.js":
/*!***************************************************!*\
  !*** ./resources/js/transitions/blogItemEnter.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../animations */ "./resources/js/animations/index.js");



var blogItemEnter = function blogItemEnter(container) {
  //  get to the top... 
  window.scrollTo(0, 0);
  var tl = gsap__WEBPACK_IMPORTED_MODULE_1__.default.timeline();
  var negativeImage = container.querySelector('.negative-image');
  (0,_animations__WEBPACK_IMPORTED_MODULE_0__.animateIn)(container.querySelector('.hero-main-text'));
  tl.from(negativeImage.querySelector('img'), {
    height: 0
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (blogItemEnter);

/***/ }),

/***/ "./resources/js/transitions/blogItemLeave.js":
/*!***************************************************!*\
  !*** ./resources/js/transitions/blogItemLeave.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var blogItemLeave = function blogItemLeave(container, trigger) {
  var items = container.querySelectorAll('.blog-listing-item a');
  var pagination = container.querySelector('.paginate nav');
  var negativeImage = container.querySelector('.negative-image');
  var img = negativeImage.querySelector('img');
  var link = negativeImage.querySelector('.negative-image-link');
  gsap__WEBPACK_IMPORTED_MODULE_0__.default.set(img, {
    'transform-orgin': 'center center'
  });
  var height = parseInt(negativeImage.innerHeight);
  var width = parseInt(negativeImage.innerWidth);
  var tl = gsap__WEBPACK_IMPORTED_MODULE_0__.default.timeline();
  tl.to(items, {
    y: '-120%',
    stagger: .1,
  ...
  if (pagination) {
    tl.to(pagination.querySelector('.pagination-left'), {
      x: -100
    }).to(pagination.querySelector('.pagination-right'), {
      x: 100
    }, '<').to(pagination.querySelector('.pagination-center'), {
      y: '-120%'
    }, '<').to(pagination.querySelector('.pagination-info'), {
      y: 100
    }, '<').to(img, {
      height: 0,
      x: "+=" + width / 2,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (blogItemLeave);

/***/ }),

/***/ "./resources/js/transitions/index.js":
/*!*******************************************!*\
  !*** ./resources/js/transitions/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "blogItemEnter": () => (/* reexport safe */ _blogItemEnter__WEBPACK_IMPORTED_MODULE_0__.default),
/* harmony export */   "blogItemLeave": () => (/* reexport safe */ _blogItemLeave__WEBPACK_IMPORTED_MODULE_1__.default),
/* harmony export */   "mainNavigationLeave": () => (/* reexport safe */ _mainNavigationLeave__WEBPACK_IMPORTED_MODULE_2__.default),
/* harmony export */   "mainNavigationEnter": () => (/* reexport safe */ _mainNavigationEnter__WEBPACK_IMPORTED_MODULE_3__.default),
/* harmony export */   "mainNavigationOnce": () => (/* reexport safe */ _mainNavigationOnce__WEBPACK_IMPORTED_MODULE_4__.default)
/* harmony export */ });
/* harmony import */ var _blogItemEnter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blogItemEnter */ "./resources/js/transitions/blogItemEnter.js");
/* harmony import */ var _blogItemLeave__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blogItemLeave */ "./resources/js/transitions/blogItemLeave.js");
/* harmony import */ var _mainNavigationLeave__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mainNavigationLeave */ "./resources/js/transitions/mainNavigationLeave.js");
/* harmony import */ var _mainNavigationEnter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mainNavigationEnter */ "./resources/js/transitions/mainNavigationEnter.js");
/* harmony import */ var _mainNavigationOnce__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mainNavigationOnce */ "./resources/js/transitions/mainNavigationOnce.js");
...
/***/ "./resources/js/transitions/mainNavigationEnter.js":
/*!*********************************************************!*\
  !*** ./resources/js/transitions/mainNavigationEnter.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var mainNavigationEnter = function mainNavigationEnter(current, next) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mainNavigationEnter);

/***/ }),

/***/ "./resources/js/transitions/mainNavigationLeave.js":
/*!*********************************************************!*\
  !*** ./resources/js/transitions/mainNavigationLeave.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var _components_hamburger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/hamburger */ "./resources/js/components/hamburger.js");



var mainNavigationLeave = function mainNavigationLeave(container) {
  var topLeft = document.querySelector('.screen-top-left');
  var topRight = document.querySelector('.screen-top-right');
  var bottomLeft = document.querySelector('.screen-bottom-left');
  var bottomRight = document.querySelector('.screen-bottom-right');
  (0,_components_hamburger__WEBPACK_IMPORTED_MODULE_0__.default)();
  var tl = gsap__WEBPACK_IMPORTED_MODULE_1__.default.timeline({
    defaults: {
      duration: .2,
      ease: "power4.out"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mainNavigationLeave);

/***/ }),

/***/ "./resources/js/transitions/mainNavigationOnce.js":
/*!********************************************************!*\
  !*** ./resources/js/transitions/mainNavigationOnce.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var mainNavigationOnce = function mainNavigationOnce() {
  // let topLeft     = document.querySelector('.screen-top-left')
  // let topRight    = document.querySelector('.screen-top-right')
  // let bottomLeft  = document.querySelector('.screen-bottom-left')
  // let bottomRight = document.querySelector('.screen-bottom-right')
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mainNavigationOnce);
