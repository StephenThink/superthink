...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _secretsanta__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./secretsanta */ "./resources/js/secretsanta/index.js");

var next = document.querySelector('.secret-santa-next');
var addMore = document.querySelector('.secret-santa-add-more');
var remove = document.querySelectorAll('.secret-santa-remove');

var _final = document.querySelector('.secret-santa-final');

var backToPage1 = document.querySelector('.secret-santa-back-to-page-1');
var submit = document.querySelector('.secret-santa-submit');
next.addEventListener('click', _secretsanta__WEBPACK_IMPORTED_MODULE_0__["toggleFlip"]);
addMore.addEventListener('click', _secretsanta__WEBPACK_IMPORTED_MODULE_0__["addFormField"]);

_final.addEventListener('click', _secretsanta__WEBPACK_IMPORTED_MODULE_0__["showFinalForm"]);

backToPage1.addEventListener('click', _secretsanta__WEBPACK_IMPORTED_MODULE_0__["showFinalForm"]);
remove.forEach(function (el) {
  return el.addEventListener('click', _secretsanta__WEBPACK_IMPORTED_MODULE_0__["removeNameFromList"]);
});
...
/***/ "./resources/js/secretsanta/addFormField.js":
/*!**************************************************!*\
  !*** ./resources/js/secretsanta/addFormField.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _removeNameFromList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./removeNameFromList */ "./resources/js/secretsanta/removeNameFromList.js");
...
var addFormField = function addFormField(e) {
  ...
  inputName.setAttribute('id', 'person' + inputNum); // inputName.setAttribute('value', 'name');
  ...
  inputEmail.setAttribute('id', 'person' + inputNum); // inputEmail.setAttribute('value', 'email');
...
/* harmony default export */ __webpack_exports__["default"] = (addFormField);

/***/ }),

/***/ "./resources/js/secretsanta/index.js":
/*!*******************************************!*\
  !*** ./resources/js/secretsanta/index.js ***!
  \*******************************************/
/*! exports provided: toggleFlip, addFormField, removeNameFromList, showFinalForm, submitForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "toggleFlip", function() { return _toggleFlip__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "addFormField", function() { return _addFormField__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _removeNameFromList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./removeNameFromList */ "./resources/js/secretsanta/removeNameFromList.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "removeNameFromList", function() { return _removeNameFromList__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _showFinalForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./showFinalForm */ "./resources/js/secretsanta/showFinalForm.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "showFinalForm", function() { return _showFinalForm__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _submitForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./submitForm */ "./resources/js/secretsanta/submitForm.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "submitForm", function() { return _submitForm__WEBPACK_IMPORTED_MODULE_4__["default"]; });
...
/***/ "./resources/js/secretsanta/removeNameFromList.js":
/*!********************************************************!*\
  !*** ./resources/js/secretsanta/removeNameFromList.js ***!
  \********************************************************/
/*! exports provided: default */
...
var removeNameFromList = function removeNameFromList(e) {
  e.preventDefault();
  var list = document.querySelectorAll('ol#nice-list li');
...
/***/ "./resources/js/secretsanta/showFinalForm.js":
/*!***************************************************!*\
  !*** ./resources/js/secretsanta/showFinalForm.js ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (showFinalForm);

/***/ }),

/***/ "./resources/js/secretsanta/submitForm.js":
/*!************************************************!*\
  !*** ./resources/js/secretsanta/submitForm.js ***!
  \************************************************/
/*! exports provided: default */
...
var submitForm = function submitForm(e) {
  ...
  loader.classList.remove('hidden'); // validate 
  // group name 
  // price
  // deadline
  // drop off point

  var form = document.getElementById('secret-santa-main-form');
  var formData = new FormData(form);
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/secret-santa-results', formData).then(function (response) {
    console.log('success');
    loader.classList.add('hidden');
    Object(_components_message__WEBPACK_IMPORTED_MODULE_1__["default"])('none', 'secretSantaMessage', response.data.success);
  })["catch"](function (_ref) {
    ...
    loader.classList.add('hidden');
    Object(_components_message__WEBPACK_IMPORTED_MODULE_1__["default"])('none', 'secretSantaMessage', response.data.error);
  }).then();
};
...
/***/ "./resources/js/secretsanta/toggleFlip.js":
/*!************************************************!*\
  !*** ./resources/js/secretsanta/toggleFlip.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (toggleFlip);

/***/ }),

/***/ 2:
/*!*************************************!*\
  !*** multi ./resources/js/santa.js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/think-2020/resources/js/santa.js */"./resources/js/santa.js");
